...
class CssStrain {
    constructor(separator = null, randomLength = 4, prefix = null, version = null) {
        ...
        this.prefix = (prefix === null) ? `${separator}${prefix}` : '';
        this.version = (version === null) ? `${separator}v${version}` : '';
...
function strainCss(cssBody, randomLength = 4, prefix = '', version = null) {
    const cssStrain = new CssStrain(randomLength, prefix, version);
